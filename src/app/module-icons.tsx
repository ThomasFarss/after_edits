...
export function isCustomIconUrl(icon: string) {
...
export function getModuleIcon(icon: string) {
  if (isCustomIconUrl(icon)) {
    ...
    return <img src={icon} alt="" className="h-full w-full rounded object-cover" />;
  }
  return MODULE_ICONS[icon] ?? MODULE_ICONS.default;
}
